...
public class Spawner : MonoBehaviour
{
	...
	public static float spawnFrequency = 6.0f;				// The time (in seconds) between spawns
	...
	void Update()
	{
        ...
        if ((Health.LEVEL - freqLevel) != 0)
        {
            spawnFrequency -= (Health.LEVEL - freqLevel) * 0.6f;
            freqLevel = Health.LEVEL;
        }
